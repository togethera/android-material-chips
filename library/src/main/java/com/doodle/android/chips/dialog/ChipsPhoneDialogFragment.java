...
public class ChipsPhoneDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View view = View.inflate(getContext(), R.layout.dialog_chips_phone, null);
        ...
        mEditText = (MaterialEditText) view.findViewById(R.id.et_ch_phonenumber);
        ...
        mErrorMsg = getString(R.string.please_enter_a_valid_phonenumber);
    ...
    private void positiveClick() {
        ...
        if (text.length() > 0 && Common.isValidPhonenumber(text)) {
            if (mPhonenumberListener != null) {
                mPhonenumberListener.onDialogPhonenumberEntered(text, mInitialText);
            }
            dismiss();
        } else {
    ...
    public interface PhonenumberListener {
        void onDialogPhonenumberEntered(String text, String displayName);
    }
}